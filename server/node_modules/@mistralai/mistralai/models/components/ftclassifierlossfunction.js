...
/** @internal */
exports.FTClassifierLossFunction$inboundSchema = z.nativeEnum(exports.FTClassifierLossFunction);
/** @internal */
...
(function (FTClassifierLossFunction$) {
    /** @deprecated use `FTClassifierLossFunction$inboundSchema` instead. */
    FTClassifierLossFunction$.inboundSchema = exports.FTClassifierLossFunction$inboundSchema;
    /** @deprecated use `FTClassifierLossFunction$outboundSchema` instead. */
    FTClassifierLossFunction$.outboundSchema = exports.FTClassifierLossFunction$outboundSchema;
